...
| §2.3 | F4/F24 ainda dependem de "nível insuficiente" como barreira quase comprovada | (a) Corrigido — fail points reformulados sem pressupor nível mínimo específico | §7: F4, F24 |
...
| §3.1 | J7a/F17: presunção de ciência automática por mera disponibilização superafirmada sem fonte específica | (a) Corrigido — redação alterada para refletir o que a Res. 957/2022 comprova (notificação digital possível; prazo 120 dias) e o que continua lacuna (marco exato de ciência) | §3: J7a; §4: B_NOTIF; §7: F17 |
